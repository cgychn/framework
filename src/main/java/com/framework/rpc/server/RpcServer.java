...
public class RpcServer {
    ...
    public RpcServer () throws IOException {
        serverSocket = new ServerSocket(MyFrameworkCfgContext.get("myrpc.provide.servicePort", Integer.class));
    ...
    public static void startRPCServer () throws IOException {
        ...
        if (MyFrameworkCfgContext.getSubNodes("myrpc.provide").size() == 0
                || MyFrameworkCfgContext.get("myrpc.provide.justSubscribe", Boolean.class) == true) {
            return;
        }

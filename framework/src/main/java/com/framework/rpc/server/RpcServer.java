...
public class RpcServer {
    ...
    static Integer serverSocketMaxAcceptCount = MyFrameworkCfgContext.get("framework.serverSocket.maxConnectedSize", Integer.class) == null ?
            18 :
            MyFrameworkCfgContext.get("framework.serverSocket.maxConnectedSize", Integer.class);
